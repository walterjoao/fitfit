...
export const bookableTrainers: BookableTrainer[] = [
  { id: "t1", name: "Ana Ferreira", specialty: "Força e hipertrofia", rating: 4.9, reviews: 84, price: "8.500 Kz", durationMin: 60, description: "Treino privado focado em ganho de massa muscular e técnica.", availability: ["Hoje 18:00", "Amanhã 07:00", "Amanhã 18:00"], cover: coverGradients[0] },
  { id: "t2", name: "Rui Ferreira", specialty: "Hipertrofia", rating: 4.7, reviews: 52, price: "7.000 Kz", durationMin: 60, description: "Sessões individuais com planos de progressão personalizados.", availability: ["Amanhã 09:00", "Qui 17:00"], cover: coverGradients[1] },
  { id: "t3", name: "Nelson Sami", specialty: "Performance e CrossFit", rating: 4.8, reviews: 41, price: "9.000 Kz", durationMin: 50, description: "Treino de alta performance para atletas de CrossFit.", availability: ["Hoje 20:00", "Sex 07:00"], cover: coverGradients[2] },
];
...
export const bookableGyms: BookableGym[] = [
  { id: "g1", name: "FitPro Talatona", location: "Talatona, Luanda", price: "1.500 Kz", durationMin: 90, description: "Acesso completo ao ginásio: sala de musculação, cardio e balneários.", availability: ["Hoje 06:00–22:00", "Amanhã 06:00–22:00"], cover: coverGradients[3] },
  { id: "g2", name: "Corpo Ativo Fitness Club", location: "Viana, Luanda", price: "1.200 Kz", durationMin: 90, description: "Ginásio completo com aulas de grupo incluídas.", availability: ["Hoje 07:00–21:00"], cover: coverGradients[4] },
];
...
export const bookableNutritionists: BookableNutritionist[] = [
  { id: "n1", name: "Inês Gonçalves", specialty: "Nutrição desportiva", rating: 4.9, reviews: 46, price: "6.500 Kz", durationMin: 40, description: "Planos nutricionais personalizados para atletas e alto rendimento.", availability: ["Qui 14:00", "Sex 10:00"], cover: coverGradients[5] },
  { id: "n2", name: "Diana Sacramento", specialty: "Perda de peso", rating: 4.6, reviews: 30, price: "5.500 Kz", durationMin: 40, description: "Acompanhamento nutricional focado em perda de peso sustentável.", availability: ["Amanhã 15:00"], cover: coverGradients[0] },
];
