...
const seedNotifications: Omit<Notification, "id">[] = [
  ...
  { recipient: "tu", message: "Subiste para #8 no leaderboard de Consistência.", time: "há 2 h", tone: "accent", category: "training", read: true, href: "/dashboard/athlete/leaderboard" },
