import { coverGradients } from "./workoutsData";
...
export const directory: Record<string, DirProfile> = {
  "ana-ferreira": {
    ...
    cover: coverGradients[0], followers: 1240, following: 86, rating: 4.9, reviews: 84, whatsapp: "+244 923 000 001",
  ...
  "ines-goncalves": {
    ...
    cover: coverGradients[5], followers: 640, following: 40, rating: 4.9, reviews: 46, whatsapp: "+244 923 000 002",
  ...
  "fitpro-talatona": {
    ...
    cover: coverGradients[3], followers: 3400, following: 12, rating: 4.7, reviews: 312,
  ...
  "nutrimax-luanda": {
    ...
    cover: coverGradients[1], followers: 890, following: 5, rating: 4.6, reviews: 120,
    reviewsList: [
  ...
  "tiago-kiala": {
    ...
    cover: coverGradients[2], followers: 210, following: 64, rating: 4.8, reviews: 12,
    reviewsList: [],
  },
};
...
export function getProfile(idOrName: string): DirProfile | undefined {
  ...
  return {
    ...
    cover: coverGradients[h % coverGradients.length],
    followers: 40 + (h % 300),
    following: 10 + (h % 120),
    rating: 4.3 + (h % 6) / 10,
    reviews: h % 30,
